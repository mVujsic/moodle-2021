    ...
    <div class="container-fluid bg">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-sm-8 col-md-4">
                <div class="info" align=center>
                    <h4 style="font-size: 35px;color:white"> <b> Администратор </b></h4>
                </div>
            </div>
        </div>
        <br>
        <div class="row justify-content-center">
            <div class="col-12 col-sm-8 col-md-4">
                    ...
                    <div class="container-fluid">
                        <a href="teacherSearch.php" class="btn btn-primary btn-lg active link1 btn-block"
                            role="button" aria-pressed="true">Претрага наставника</a>
                    </div>
                    <div class="container-fluid">
                        <a href="studentSignup.php" class="btn btn-primary btn-lg active link1 btn-block"
                            role="button" aria-pressed="true">Креирање студента</a>
                    </div>
                    <div class="container-fluid">
                        <a href="teacherSignup.php" class="btn btn-primary btn-lg active link1 btn-block"
                            role="button" aria-pressed="true">Креирање наставника</a>
                    </div>
                    <div class="container-fluid">
                        <a href="createCourse.php" class="btn btn-primary btn-lg active link1 btn-block"
                            role="button" aria-pressed="true">Креирање курса</a>
                    </div>
                    <div class="container-fluid">
